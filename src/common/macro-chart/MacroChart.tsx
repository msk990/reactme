...
export const MacroChart = (props:any) => {

  const noLegend = props.noLegend

    const total = props.proteins + props.pureCarbs + props.sugars + props.fiber + props.pureFat + props.saturated
 ...
 <div className="w-75 p-3 m-auto" style={{ position: 'relative'}}>
  ...
  <div style={{ position: 'absolute', width: '100%', top: '50%', left: 0, textAlign: 'center', marginTop: '-40px',  lineHeight: '20px'}}>
         ...
         <div className={`chart-legend mt-3 ${noLegend ? "d-none" : "d-block"}`}>
           ...
           <Row>
             ...
             <Col>
             <div className="chart-legend-box m-auto">
